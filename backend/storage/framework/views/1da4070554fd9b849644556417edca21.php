...
<?php echo $__env->make('backend.layouts.notification', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    ...
    <div class="grid grid-cols-12 gap-6 mt-5">
        <div class="intro-y col-span-12 flex flex-wrap sm:flex-nowrap items-center mt-2">
            <a href="<?php echo e(route('blog.create')); ?>" class="btn btn-primary shadow-md mr-2">Thêm bài viết</a>
            
            <div class="hidden md:block mx-auto text-slate-500">Hiển thị trang <?php echo e($blogs->currentPage()); ?> trong <?php echo e($blogs->lastPage()); ?> trang</div>
        ...
        <div class="intro-y col-span-12 overflow-auto lg:overflow-visible">
            <table class="table table-report -mt-2">
                ...
                <tbody>
                    ...
                    <tr class="intro-x">
                        <td>
                            <a target="_blank" href="<?php echo e(route('front.chinhsach.view',$item->slug)); ?>" class="font-medium whitespace-nowrap"><?php echo e($item->title); ?></a> 
                        </td>
                        <td class="text-left"><?php echo e($item->cat_id?\App\Models\BlogCategory::find($item->cat_id)->title:''); ?></td>
                        <td class="w-40">
                            <div class="flex">
                        ...
                        <td class="table-report__action w-56">
                            <div class="flex justify-center items-center">
                                <a href="<?php echo e(route('blog.edit',$item->id)); ?>" class="flex items-center mr-3" href="javascript:;"> <i data-lucide="check-square" class="w-4 h-4 mr-1"></i> Edit </a>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('backend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Flutter\codetai\flutterbekeryapp 2\flutterbekeryapp 2\backend\resources\views/backend/blog/index.blade.php ENDPATH**/ ?>