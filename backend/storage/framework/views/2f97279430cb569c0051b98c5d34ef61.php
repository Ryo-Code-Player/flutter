    ...
    <div class="container py-[4.5rem] xl:!py-24 lg:!py-24 md:!py-24">
        <div class="flex flex-wrap  mx-[-15px] mt-[-60px]">
            <div class="xl:w-9/12 lg:w-9/12 w-full flex-[0_0_auto] px-[15px] max-w-full md:px-[20px] lg:px-[20px] xl:px-[35px]">
                <div class="flex flex-wrap mx-[-15px] md:mx-[-20px] lg:mx-[-20px] xl:mx-[-35px] mt-[-40px]">
                                ...
                                <div class="swiper-wrapper">
                                    ...
                                    <div class="swiper-slide group">
                                        <figure class="rounded-[0.4rem]">
                                            <img class="rounded-[0.4rem]" src="<?php echo e($photo); ?>"   alt="<?php echo e($product->title); ?>">
                                            ...
                                            href="<?php echo e($photo); ?>" data-glightbox data-gallery="product-group">
                            ...
                            <div class="swiper swiper-thumbs">
                                    <div class="swiper-wrapper">
                                        ...
                                        <div class="swiper-slide">
                                            <img src="<?php echo e($photo); ?>"  style="width:114px; height: 120px" class="rounded-[.4rem]" alt="<?php echo e($product->title); ?>"></div>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <div class="xl:w-6/12 lg:w-6/12 w-full flex-[0_0_auto] px-[15px] xl:px-[35px] lg:px-[20px] mt-[40px] max-w-full">
                        <div class="post-header mb-5">
                            <h2 class="post-title text-[calc(1.285rem_+_0.42vw)] font-bold xl:text-[1.6rem] leading-[1.3]"><?php echo e($product->title); ?> </h2>
                            <p class="price text-[1rem] mb-2"><span class="   amount"><?php echo e(number_format($product->price,0,'.',',')); ?> đ</span></p>
                        </div>
                ...
                <!-- /.tab-content -->
                <?php echo $__env->make('frontend_tp.layouts.mod_4_pro', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            ...
            <aside class="  hidden xl:block lg:block  xl:w-3/12 lg:w-3/12 w-full flex-[0_0_auto] xl:px-[15px] lg:px-[15px] px-[15px] max-w-full sidebar mt-[0rem] xl:!mt-0 lg:!mt-0">
                <?php echo $__env->make('frontend_tp.layouts.sideproduct', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                <?php echo $__env->make('frontend_tp.layouts.catpromenu', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                <?php echo $__env->make('frontend_tp.layouts.sidehotproduct', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            </aside>
        </div>
    </div>
      <!-- /.container -->
...
<?php echo $__env->make('frontend_tp.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Flutter\backup\flutterbekeryapp 2\backend\resources\views/frontend_tp/product/single.blade.php ENDPATH**/ ?>