...
<?php echo $__env->make('backend.layouts.notification', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    ...
    <div class="grid grid-cols-12 gap-6 mt-5">
        <div class="intro-y col-span-12 flex flex-wrap sm:flex-nowrap items-center mt-2">
            <a href="<?php echo e(route('user.create')); ?>" class="btn btn-primary shadow-md mr-2">Thêm người dùng</a>
            
            <div class="hidden md:block mx-auto text-slate-500">Hiển thị trang <?php echo e($users->currentPage()); ?> trong <?php echo e($users->lastPage()); ?> trang</div>
        ...
        <div   class=" intro-y col-span-12 flex flex-col sm:flex-row sm:items-end xl:items-start">
            <form action="<?php echo e(route('user.sort')); ?>" method = "get" class="xl:flex sm:mr-auto" >
            ...
            <table class="table table-report -mt-2">
                ...
                <tbody>
                    ...
                    <tr class="intro-x">
                        ...
                        <td class="text-center"><?php echo e($item->ugroup_id!= null?\App\Models\UGroup::where('id',$item->ugroup_id)->value('title'):''); ?> </td>
                        ...
                        <td class="table-report__action w-56">
                            <div class="flex justify-center items-center">
                                <a href="<?php echo e(route('user.edit',$item->id)); ?>" class="flex items-center mr-3" href="javascript:;"> <i data-lucide="check-square" class="w-4 h-4 mr-1"></i> Edit </a>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('backend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Python\xampp\htdocs\shoplite-main\shoplite-main\resources\views/backend/users/index.blade.php ENDPATH**/ ?>