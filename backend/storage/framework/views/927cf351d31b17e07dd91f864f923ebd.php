            ...
            <form method="post" action="<?php echo e(route('category.update',$category->id)); ?>">
                ...
                <div class="intro-y box p-5">
                    <div>
                        ...
                        <input id="title" name="title" type="text" value="<?php echo e($category->title); ?>" class="form-control" placeholder="title">
                    </div>
                    <div class="mt-3">
                    ...
                    <div class="mt-3">  
                        <div class="flex flex-col sm:flex-row mt-2">
                            <div class="form-check mr-2"> 
                                ...
                                <?php echo e($category->is_parent==1? 'checked': ''); ?>
                    ...
                    <div class="mt-3">
                        <div id="div_parent_id" class="  flex flex-col sm:flex-row items-center">
                            ...
                            <select name="parent_id" class="form-select mt-2 sm:mr-2" aria-label="Default select example"   >
                                ...
                                <?php $__currentLoopData = $parent_cats; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pcat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('backend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Flutter\codemoi\flutterbekeryapp 2\flutterbekeryapp 2\backend\resources\views/backend/categories/edit.blade.php ENDPATH**/ ?>