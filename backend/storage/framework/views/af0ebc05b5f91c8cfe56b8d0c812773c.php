<?php
    $rand_pros = \DB::select("SELECT * from products where   status = 'active' and `is_sold`=1 order by hit LIMIT 8");;
...
<section class="wrapper !bg-[#ffffff]">
    ...
    <div class="container pb-[1.5rem] xl:pb-10 lg:pb-10 md:pb-10 pt-14">
        <div class="post-header mt-[-50px]">
            <div class="">
            <h2><a href="<?php echo e(route('front.product.hot')); ?>" class=" hover" rel="category"><i class="uil uil-box"></i>SẢN PHẨM YÊU THÍCH</a></h2>
            </div>
            <!-- /.post-category -->
        </div>
        ...
        <div class="itemgrid grid-view projects-masonry shop mb-5">
            <div class="flex flex-wrap mx-[-15px] xl:mx-[-0px] lg:mx-[-0px] md:mx-[-0px] mt-[-0px] xl:mt-[-0px] lg:mt-[-0px] md:mt-[-0px] isotope">
                <?php $__currentLoopData = $rand_pros; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pro): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <?php
                ...
                ?>
                    <div class="project item group md:w-6/12 lg:w-3/12 xl:w-3/12 w-full flex-[0_0_auto] xl:px-[10px] lg:px-[10px] md:px-[10px] px-[10px] mt-[10px] xl:mt-[10px] lg:mt-[10px] md:mt-[10px] max-w-full">
                        <figure style="  height:250px; overflow:hidden; padding:0px"  class=" !rounded-[.4rem] !mb-6">
                            <a href="<?php echo e(route('front.product.view',$pro->slug)); ?>" title="<?php echo e($pro->title); ?>" alt ="<?php echo e($pro->title); ?>"
                                    class="title_color">
      ...
      <!-- /.container -->
    </section><?php /**PATH E:\Flutter\codetai\flutterbekeryapp 2\flutterbekeryapp 2\backend\resources\views/frontend_tp/layouts/mod8hotpro.blade.php ENDPATH**/ ?>