                            ...
                            <div class="card" style="padding-right:10px;padding-left:10px;">
                                ...
                                <figure class="!rounded-[.4rem] !mb-6" style=" height:250px; overflow:hidden; padding:0px">
                                    ...
                                    ?>
                                     <a href="<?php echo e(route('front.product.view',$product->slug)); ?>">
                                        <img src="<?php echo e($photos[0]); ?>" alt="<?php echo e($product->title); ?>">
                                    </a>
                                ...
                                <div class="post-header"  style=" height:100px; overflow:hidden; padding:0px">
                                    <div class="flex flex-row items-center justify-between mb-2">
                                        <?php if($cat): ?>
                                            <div class="uppercase tracking-[0.02rem] text-[0.7rem] font-bold text-[#9499a3] !mb-0"><?php echo e($cat->title); ?></div>
                                        <?php endif; ?>
                                    </div>
                                    <h2 class="post-title h3 text-[1.1rem]"><a href="<?php echo e(route('front.product.view',$product->slug)); ?>" class="title_color"> <?php echo e($product->title); ?></a></h2>
                                    
                                </div>
                                <p class="price !m-0"> <ins class="no-underline  "><span class="amount"><?php echo e(number_format($product->price,0,'.',',')); ?> đ</span></ins></p>
                                <!-- /.post-header -->
...
<?php echo $__env->make('frontend_tp.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Python\xampp\htdocs\shoplite-main\shoplite-main\resources\views/frontend_tp/product/category.blade.php ENDPATH**/ ?>