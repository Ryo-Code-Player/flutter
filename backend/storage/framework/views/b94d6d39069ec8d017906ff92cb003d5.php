                                ...
                                <div class="post-header"  style=" height:100px; overflow:hidden; padding:0px">
                                    ...
                                    <?php if($cat): ?>
                                        <div class="uppercase tracking-[0.02rem] text-[0.7rem] font-bold text-[#9499a3] !mb-0">
                                            <a class="secondarytextcolor  " href="<?php echo e(route('front.product.cat',$cat->slug)); ?>">  <?php echo e($cat->title); ?> </a>
                                        </div>
                                    <?php endif; ?>
                                    </div>
...
<?php echo $__env->make('frontend_tp.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Python\xampp\htdocs\shoplite-main\shoplite-main\resources\views/frontend_tp/product/hot.blade.php ENDPATH**/ ?>