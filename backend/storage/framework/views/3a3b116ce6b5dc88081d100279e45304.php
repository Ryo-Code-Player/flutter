...
<section class="wrapper !bg-[#ffffff]">
    ...
    <div class="container pb-[1.5rem] xl:pb-10 lg:pb-10 md:pb-10 pt-14">
        <div class="post-header mt-[-50px]">
            <div class="">
            <h2><a href="<?php echo e(route('front.product.hot')); ?>" class=" hover" rel="category"><i class="uil uil-box"></i> CÓ THỂ BẠN QUAN TÂM</a></h2>
            </div>
            <!-- /.post-category -->
        </div>
      ...
      <!-- /.container -->
    </section><?php /**PATH E:\Flutter\codemoi\flutterbekeryapp 2\flutterbekeryapp 2\backend\resources\views/frontend_tp/layouts/mod8randpro.blade.php ENDPATH**/ ?>