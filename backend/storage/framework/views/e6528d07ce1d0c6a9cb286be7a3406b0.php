...
<div class="offcanvas-body flex flex-col">
            ...
            <div class="shopping-cart-item flex justify-between !mb-4">
                <div class="flex flex-row">
                    ...
                    <div class="!w-full !ml-[1rem]">
                        <h3 class="post-title !text-[.8rem] !leading-[1.35] !mb-1"><a href="<?php echo e(route('front.product.view',$procart->slug)); ?>" class="title_color"><?php echo e($procart->title); ?></a></h3>
                        <p class="price !text-[.7rem]"> <ins class="no-underline text-[#e2626b]"><span class="amount"><?php echo e(number_format($procart->price,0,'.',',')); ?>đ</span></ins> x  <?php echo e($procart->quantity); ?></p>
    ...
    <a href="<?php echo e(route('front.shopingcart.checkout')); ?>" class="btn btn-primary text-white !bg-[#3f78e0] border-[#3f78e0] hover:text-white hover:bg-[#3f78e0] hover:border-[#3f78e0] focus:shadow-[rgba(92,140,229,1)] active:text-white active:bg-[#3f78e0] active:border-[#3f78e0] disabled:text-white disabled:bg-[#3f78e0] disabled:border-[#3f78e0] btn-icon btn-icon-start rounded !w-full !mb-4 hover:translate-y-[-0.15rem] hover:shadow-[0_0.25rem_0.75rem_rgba(30,34,40,0.15)]"><i class="uil uil-credit-card !text-[.9rem] mr-[0.3rem] before:content-['\ea74']"></i>Mua hàng</a>
    <p class="!text-[.7rem] !mb-0">Liên hệ hotline: <?php echo e($setting->hotline); ?> nếu gặp khó khăn trong quá trình mua hàng!</p>
    </div>
    <!-- /.offcanvas-footer-->
</div><?php /**PATH E:\Flutter\codetai\flutterbekeryapp 2\flutterbekeryapp 2\backend\resources\views/frontend_tp/layouts/quickcart.blade.php ENDPATH**/ ?>