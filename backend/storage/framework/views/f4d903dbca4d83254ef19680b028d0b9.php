                        ...
                        <div id="div_parent_id" class="  flex flex-col sm:flex-row items-center">
                            ...
                            <select name="parent_id" class="form-select mt-2 sm:mr-2" aria-label="Default select example"   >
                                ...
                                <?php $__currentLoopData = $parent_cats; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pcat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($pcat->id); ?>"><?php echo e($pcat->title); ?></option>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('backend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Flutter\codemoi\flutterbekeryapp 2\flutterbekeryapp 2\backend\resources\views/backend/categories/create.blade.php ENDPATH**/ ?>