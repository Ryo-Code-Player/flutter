            ...
            <div class="xl:w-8/12 lg:w-8/12 w-full flex-[0_0_auto] xl:px-[35px] lg:px-[20px] md:px-[20px] px-[15px] mt-[70px] max-w-full">
                ...
                <div class="flex flex-wrap mx-[-15px] mt-0">
                    ...
                    <div class="md:w-4/12 lg:w-5/12 xl:w-5/12 w-full flex-[0_0_auto] px-[15px] max-w-full ml-auto lg:!ml-0 xl:!ml-0 xl:!text-right lg:!text-right md:!text-right mt-[20px]">
                        <a href="<?php echo e(route('front.shopingcart.checkout')); ?>" class="btn btn-primary text-white secondarybackgroundcolor border-[#3f78e0] hover:text-white hover:bg-[#3f78e0] hover:border-[#3f78e0] focus:shadow-[rgba(92,140,229,1)] active:text-white active:bg-[#3f78e0] active:border-[#3f78e0] disabled:text-white disabled:bg-[#3f78e0] disabled:border-[#3f78e0] rounded hover:translate-y-[-0.15rem] hover:shadow-[0_0.25rem_0.75rem_rgba(30,34,40,0.15)]">
                            Đặt hàng
                        </a>
                    </div>
                </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('frontend_tp.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Python\xampp\htdocs\shoplite-main\shoplite-main\resources\views/frontend_tp/cart/view.blade.php ENDPATH**/ ?>