...
<?php $__env->startSection('content'); ?>
    ...
    <?php if(!auth()->user()): ?>
        ...
        <div class="flex flex-wrap mx-[-15px]  " style="padding-top:20px">
          <div class="lg:w-7/12 xl:w-6/12 xxl:w-5/12 w-full flex-[0_0_auto] px-[15px] max-w-full !mx-auto !mt-[10rem]">
            <div class="card">
              <div class="card-body !p-12 !text-center">
                ...
                <form method="POST" action="<?php echo e(route('front.login')); ?>" class="text-left !mb-3">
                  <?php echo csrf_field(); ?>
                  ...
                  <input type='hidden' name='plink' value='<?php echo e(isset($plink)?$plink:""); ?>'/>
                ...
                <!-- /form -->
                <p class="!mb-1">  <?php if(Route::has('password.request')): ?>
                                <a class=" btn-link" href="<?php echo e(route('password.request')); ?>">
                                  <?php echo e(__('Quên mật khẩu?')); ?>

                                </a>
                              <?php endif; ?></p>
                <p class="!mb-0">Bạn chưa có tài khoản? <a href="<?php echo e(route('front.register')); ?>" class="hover">Đăng ký</a></p>
...
<?php echo $__env->make('frontend_tp.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Python\xampp\htdocs\shoplite-main\shoplite-main\resources\views/frontend_tp/auth/login.blade.php ENDPATH**/ ?>